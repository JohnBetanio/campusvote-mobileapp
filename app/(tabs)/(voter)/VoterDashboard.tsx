    ...
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      ...
      <View style={styles.statusBanner}>
        ...
        <Text style={styles.statusBannerText}>
          ...
          <Text>2 active election(s) available</Text>
        </Text>
      </View>
      ...
      <View style={styles.announceCard}>
        ...
        <View style={styles.announceItem}>
          <View style={[styles.announceBar, { backgroundColor: Colors.success }]} />
          <View style={styles.announceContent}>
            <Text style={styles.announceIcon}>🗓️</Text>
            <Text style={styles.announceText}>Election debate scheduled for May 25th at 2pm in the Student Union.</Text>
          </View>
        </View>
        <View style={styles.announceItem}>
          <View style={[styles.announceBar, { backgroundColor: Colors.warning }]} />
          <View style={styles.announceContent}>
            <Text style={styles.announceIcon}>⚠️</Text>
            <Text style={styles.announceText}>Voting ends May 30 – make sure to cast your vote!</Text>
          </View>
        </View>
        <View style={styles.announceItem}>
          <View style={[styles.announceBar, { backgroundColor: Colors.success }]} />
          <View style={styles.announceContent}>
            ...
            <Text style={styles.announceText}>New candidates added for Academic Senate election.</Text>
          </View>
        </View>
      </View>
    </ScrollView>
