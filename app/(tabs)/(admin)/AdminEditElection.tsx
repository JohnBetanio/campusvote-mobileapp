...
export default function AdminEditElectionScreen() {
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      <Text style={styles.pageTitle}>Edit Election</Text>
      <Text style={styles.pageSubtitle}>Modify election details</Text>
      <View style={styles.emptyCard}>
        <Text style={styles.emptyIcon}>✏️</Text>
        <Text style={styles.emptyTitle}>Edit Election</Text>
        <Text style={styles.emptyDesc}>Election editing coming soon.</Text>
      </View>
    </ScrollView>
  );
}
